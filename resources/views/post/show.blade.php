    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
        <div class="col-md-9 ftco-animate pb-5 text-center">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="{{url('/')}}">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="{{route('Blog')}}">Blog <i class="ion-ios-arrow-forward"></i></a></span> <span>{{$post->title}}<i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
</section>
        ...
        <div class="col-lg-8 ftco-animate">
         ...
         <div class="tag-widget post-tag-container mb-5 mt-5">
          ...
          <div class="about-author d-flex p-4 bg-light">
            <div class="bio mr-5">
              {{-- avatar --}}
              <img src="/storage/{{$post->author->avatar}}" width="100%" height="100%" alt="Image placeholder"  class="img-fluid mb-4">
            </div>
            <div class="desc">
              <h3>{{$post->author->name}}</h3>
              <p>This article was written by <strong> {{$post->author->name}} </strong>. He is a distinguished writer for us and very skilled, I am speaking to you on his behalf.If you want to join us. Email us</p>
